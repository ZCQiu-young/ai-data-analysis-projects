...
| 5 | [Olist 电商差评根因分析](PROJECTS/05_Olist_Bad_Review_Analysis) | EDA→SQL→统计检验→NLP→LDA→策略 | 六步链路 · 差评三类型定位 · RR=6.9× · 品类三级干预 |
...
│   └── reports/   7 张分析图表
│
└── 05_Olist_Bad_Review_Analysis/                # 项目5：Olist 差评根因全链路分析
